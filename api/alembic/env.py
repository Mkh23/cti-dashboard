...
def include_object(object, name, type_, reflected, compare_to):
    ...
    # Ignore PostGIS tiger geocoding tables and topology tables
    if type_ == "table" and name in (
        "spatial_ref_sys", "geography_columns", "geometry_columns", "raster_columns", "raster_overviews",
        "layer", "topology",
        # TIGER geocoder tables
        "addr", "addrfeat", "bg", "county", "countysub_lookup", "cousub", "direction_lookup",
        "edges", "faces", "featnames", "geocode_settings", "loader_lookuptables", "loader_platform",
